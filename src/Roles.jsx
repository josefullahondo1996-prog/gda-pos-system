...
export default function Roles() {
    ...
    return (
        <div className="bg-transparent text-sm text-gray-700">
            ...
            <p className="text-gray-400 text-xs mb-4">Gestionar roles</p>

            <div className="bg-white rounded-lg shadow-sm border-t-2 border-[#004284]">
                <div className="p-4 border-b border-gray-100 flex justify-between items-center">
                    <h3 className="font-bold text-gray-700">Todos los roles</h3>
                ...
                <div className="p-4">
                    ...
                    <table className="w-full text-left text-sm border-collapse">
                        ...
                        <tbody>
                            {cargando ? (
                                <tr><td colSpan={2} className="text-center py-8 text-gray-400">Cargando...</td></tr>
                            ) : rolesFiltrados.length === 0 ? (
                                <tr><td colSpan={2} className="text-center py-8 text-gray-400">No hay roles registrados.</td></tr>
                            ) : (
                    ...
                    <div className="text-xs font-bold text-gray-500 mt-4">
                        Mostrando 1 a {Math.min(porPagina, rolesFiltrados.length)} de {rolesFiltrados.length} entradas
                    </div>
                </div>
            </div>
        </div>
