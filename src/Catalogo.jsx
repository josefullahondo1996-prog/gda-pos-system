    ...
    <div className="bg-transparent mt-2">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border-t-2 border-[#004284] mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            <label className="block text-gray-500 font-bold mb-1">Estado de compra:</label>
            <select className="w-full border rounded p-1"><option>Todos</option></select>
          </div>
          <div>
            <label className="block text-gray-500 font-bold mb-1">Estado de pago:</label>
            <select className="w-full border rounded p-1"><option>Todos</option></select>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border-t-2 border-[#004284]">
        ...
        {mostrarFormulario ? (
           <div className="p-6 bg-gray-50">
             ...
             <button onClick={registrarCompra} className="bg-[#004284] text-white p-2 rounded font-bold w-full">Guardar y Sumar Stock</button>
           </div>
        ) : (
          ...
          <div className="p-4">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm border-collapse">
                ...
                <tbody>
                  {compras.length === 0 ? (
                    <tr><td colSpan="10" className="text-center p-6 text-gray-500">No hay compras registradas.</td></tr>
                  ) : (
                    compras.map(compra => {
